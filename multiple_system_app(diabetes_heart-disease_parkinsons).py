...
diabetes_model = pickle.load(open("D:/code/python/ML/ML_project/Diabetes_prediction/Diabetes_prediction_trained_model.sav",'rb'))

heart_disease_model = pickle.load(open("D:/code/python/ML/ML_project/Heart_disease_prediction/heart_disease_prediction_trained_model.sav",'rb'))

parkinsons_model = pickle.load(open("D:/code/python/ML/ML_project/parkinsons_prediction/parkinsons_model.sav",'rb'))
